<section class="banner-container">
		<div style="background-image: url('<?php echo INCLUDE_PATH; ?>images/bg_form.jpg');" class="banner-single"></div> <!-- Banner single -->
		<div style="background-image:url('<?php echo INCLUDE_PATH; ?>images/slider1.jpg');" class="banner-single"></div> <!-- Banner single -->
		<div style="background-image:url('<?php echo INCLUDE_PATH; ?>images/slider2.jpg');" class="banner-single"></div> <!-- Banner single -->
